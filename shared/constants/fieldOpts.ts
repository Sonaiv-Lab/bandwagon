...
*/
export const FIELDS = {
  F04: { shortName: '台南', name: '台南棒球場', fullName: '台南市立體育棒球場' },
  F07: { shortName: '嘉義市', name: '嘉義棒球場', fullName: '嘉義市立體育棒球場' },
  F08: { shortName: '新莊', name: '新莊棒球場', fullName: '新北市市立新莊棒球場' },
  F09: { shortName: '澄清湖', name: '澄清湖棒球場', fullName: '高雄市澄清湖棒球場' },
  F10: { shortName: '天母', name: '臺北市立天母棒球場', fullName: '臺北市立天母棒球場' },
  ...
  F19: { shortName: '洲際', name: '台中洲際棒球場', fullName: '台中市洲際棒球場' },
  F23: { shortName: '樂天桃園', name: '樂天桃園棒球場', fullName: '樂天桃園棒球場' },
